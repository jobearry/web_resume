...
export const Profile = ({className}: ProfileProp) => {
  return (
    <section className={`my-6 items-center ${className}`} aria-labelledby='profile-heading'>
      <figure className='m-4'>
        <img className='rounded-full m-auto border border-gray-500' src={pic} alt='Jonathan Golimlim profile photo' />
      ...
      <div className='flex flex-col justify-center'>
        ...
        <p className='flex items-center text-sm gap-1 justify-center'>
